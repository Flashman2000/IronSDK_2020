...
public class DriverOpRD extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.backYk.setPosition(0.1);
        robot.backYkA.setPosition(0.42);
        robot.frontYk.setPosition(0.8);
        robot.frontYkA.setPosition(0.45);
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.dpad_down) {
                robot.frontYkA.setPosition(0.8);
            }
            ...
            if (gamepad2.left_stick_y < 0) {
                while (gamepad2.left_stick_y < 0) {
                    ...
                    spoolpowr = gamepad2.right_trigger - gamepad2.left_trigger;
                    robot.spool.setPower(spoolpowr);
                    robot.spool2.setPower(spoolpowr);
